 ...
 * 
 * ADAPTIVECS->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Adaptive_Css_Grid_Columns_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		ADAPTIVECS
 * @subpackage	Classes/Adaptive_Css_Grid_Columns_Settings
...
class Adaptive_Css_Grid_Columns_Settings{
	...
	/**
	 * Our Adaptive_Css_Grid_Columns_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = ADAPTIVECS_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'ADAPTIVECS/settings/get_plugin_name', $this->plugin_name );
	}
}
